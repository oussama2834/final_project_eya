...
@Component({
  selector: 'app-seanceformation',
  templateUrl: './seanceformation.component.html',
  styleUrls: ['./seanceformation.component.css']
})
export class SeanceformationComponent {
